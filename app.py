...
#client = MongoClient("mongodb://127.0.0.1:8081/?ssl=true") #host uri
#db = client.test    #Select the database
#db.authenticate(name="localhost",password='C2y6yDjf5' + r'/R' + '+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==' + r'/Jw==')

## Comment out when running locally
client = MongoClient(os.getenv("MONGOURL"))
db = client.customers    #Select the database
